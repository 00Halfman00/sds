...
def get_ticket_price(city):
    return f"The price of a ticket to {city.title()} is $799."


""" SIMPLE CHAT LLM FUNCTION TO USE IN THE GRADIO UI """
...
system_msg += "If relevant, the price of a ticket to London is $799."
